...
let moveList = ["Piedra", "Papel", "Tijera"];
...
function startGame() {
  statusDisplay.textContent = "Elige!";
...
function endGame(event) {
  ...
  moveDisplays[0].textContent = `Tu elegiste ${moveList[playerMove]}`;
  moveDisplays[1].textContent = `AI eligió ${moveList[computerMove]}`;
